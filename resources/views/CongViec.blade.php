                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group my-2">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text bg-danger text-light" style="cursor: pointer"><b>Thêm mới công
                                        việc</b></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert border border-primary" role="alert">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-6 text-right">
                                    <button class="btn btn-warning text-light" v-on:click="value.tinh_trang = 0">Undo</button>
                                </div>
                            </div>
                        </div>
                        </template>
